    ...
    <div className="page-refresco-container">
      ...
      <div className="page-refresco-header">
        ...
        >
          ...
          <Link to="/" className="page-refresco-login2 button">
            Inicio
          </Link>
        </header>
      </div>
      <div className="page-refresco-hero">
        ...
        />
        <h2 className="page-refresco-text12">Tu código: 4NS73KC8</h2>
      </div>
