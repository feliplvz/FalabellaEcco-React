...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>FalabellaRewards</title>
        <meta property="og:title" content="FalabellaRewards" />
      </Helmet>
          ...
          <div data-thq="thq-mobile-menu" className="home-mobile-menu">
            <div className="home-nav">
              <div className="home-top">
                <span className="home-logo">SCANIT</span>
      ...
      <div className="home-hero">
        <div className="home-hero1">
          <div className="home-container3">
            <h1 className="home-hero-heading heading1">Escanea y gana</h1>
            <span className="home-hero-sub-heading">
              Recompensas y mucho más!
            </span>
            <div className="home-btn-group">
              <Link to="/page" className="home-hero-button1 button">
                Comenzar
              </Link>
              <button className="home-hero-button2 button">Saber más →</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <footer className="home-footer1">
          ...
          <div className="home-container5">
            <nav className="home-nav1 home-nav1">
              ...
              <span className="home-nav41">Política de privacidad</span>
            </nav>
          </div>
